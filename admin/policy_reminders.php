...
FROM users JOIN policy_data ON users.id=policy_data.client_id WHERE insurance_enddate > $today";
...
if($result){
    ...
    $exp_date=$row[$i]['insurance_enddate'];
	...
	if($remain_date==7){
		...
		$mail->Body     .= "<h1>Your insurance having number &nbsp;&nbsp; <u>{$insurance_number}</u> &nbsp;&nbsp;will expire in 7 days please renew this</h1><br/>"; 
